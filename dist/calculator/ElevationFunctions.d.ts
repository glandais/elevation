...
export declare function normalizePixel(pixel: Pixel, tileSize: number): Pixel;
 ...
 */
export declare function toPixel(coords: Coordinates, z: number, tileSize: number): Pixel;
